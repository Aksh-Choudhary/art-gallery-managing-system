...
<body style="background-color: #EBF4FA">
 ...
 <th><br>Cust ID<br><br></th> 
  ...
  <?php
$con = mysqli_connect("localhost", "root", "Ch0udh@ry", "art_gallery");
echo " <b><center>Creating Stored Procedure...</center></b>";
  ...
  if ($result = mysqli_query($con,"CALL GetAge()"))
   ...
   while($row = $result->fetch_assoc())
    {
    echo "<tr><td>" . $row["CUSTID"]. "</td><td>" . $row["GID"]. "</td><td>" . $row["FNAME1"]. "</td><td>" . $row["LNAME1"]. "</td><td>" . $row["DOB"]. "</td><td>" . $row["ADDRESS"]. "</td><td>". $row["age"]. "</td></tr>";
    }
    echo "</table>";
    }
else 
